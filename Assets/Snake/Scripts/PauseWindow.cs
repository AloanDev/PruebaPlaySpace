...
public class PauseWindow : MonoBehaviour {
    ...
    private void Awake() {
        ...
        transform.Find("mainMenuBtn").GetComponent<Button_UI>().ClickFunc = () => GameHandler.ResumeGame();
        ...
        transform.Find("retryBtn").GetComponent<Button_UI>().ClickFunc = () => GameHandler.ResumeGame();
