...
public class GameOverWindow : MonoBehaviour {
    ...
    private void Show(bool isNewHighscore) {
        ...
        transform.Find("highscoreCoinsText").GetComponent<TextMeshPro>().text = "HIGHSCORE COINS" + Score.GetHighscoreCoins();
        transform.Find("highscoreGemsText").GetComponent<TextMeshPro>().text = "HIGHSCORE GEMS" + Score.GetHighscoreGems();
    }
